...
| R-06 | Anniversary and reminder notifications | SRS.md (FR-06) | Planned |
| R-07 | Health endpoint and service readiness | API_REFERENCE.md (Implemented Endpoints) | Implemented |
| R-08 | Go backend runtime migration | SOFTWARE_DESIGN_DOCUMENT.md (Migration Notes) | In Progress |
